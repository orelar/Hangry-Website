...
export function FindUs() {
  return (
    <>
      <div className="bg-white text-center flex flex-col items-center space-y-10 mt-[70rem] py-20 md:py-60 sm:py-60 sm:mt-56 md:mt-32 w-full">
        <p className="text-black-hangry md:text-sm text-xs">Hangry! dapat kamu temukan di</p>
        <div className="flex md:gap-1 lg:gap-3 sm:space-x-12 space-x-8 mx-2 md:mx-10" id="delivery">
